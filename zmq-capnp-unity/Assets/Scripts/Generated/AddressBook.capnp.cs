...
namespace CapnpGen
{
    [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0xbf9f4510d279489dUL)]
    public class Person : ICapnpSerializable
    {
        public const UInt64 typeId = 0xbf9f4510d279489dUL;
        ...
        [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0xa595895614f2df77UL)]
        public class employment : ICapnpSerializable
        {
            public const UInt64 typeId = 0xa595895614f2df77UL;
            ...
            public struct READER
            {
                ...
                public string Employer => which == WHICH.Employer ? ctx.ReadText(3, null) : default;
                public string School => which == WHICH.School ? ctx.ReadText(3, null) : default;
            }
            ...
            public class WRITER : SerializerState
            {
                ...
                public string Employer
                {
                    get => which == WHICH.Employer ? this.ReadText(3, null) : default;
                    set => this.WriteText(3, value, null);
                }

                public string School
                {
                    get => which == WHICH.School ? this.ReadText(3, null) : default;
                    set => this.WriteText(3, value, null);
                }
            }
        }

        [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0xa3d6ac2d573244cfUL)]
        public class PhoneNumber : ICapnpSerializable
        {
            public const UInt64 typeId = 0xa3d6ac2d573244cfUL;
            void ICapnpSerializable.Deserialize(DeserializerState arg_)
            {
                var reader = READER.create(arg_);
            ...
            [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0xb70f4139e8bf847fUL)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("capnpc-csharp", "1.3.0.0"), TypeId(0xd21354add4058097UL)]
    public class AddressBook : ICapnpSerializable
    {
        public const UInt64 typeId = 0xd21354add4058097UL;
        void ICapnpSerializable.Deserialize(DeserializerState arg_)
        {
            var reader = READER.create(arg_);
